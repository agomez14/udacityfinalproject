...
/**
 * Created by barryjohnsonsmith on 8/12/15.
 */
public class SearchFoodPictureTask extends AsyncTask<ArrayList<String>, Void, String>  private final String LOG_TAG = SearchFoodTask.class.getSimpleName();
private GridViewAdapter gridAdapter;
private final Context mContext;

        public SearchFoodPictureTask(Context context, GridViewAdapter gridAdapter) {
            mContext = context;
